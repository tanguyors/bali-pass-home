              ...
              ${activeDays.slice(0, 5).map((day: any, index: number) => {
                ...
                return `
                  <div style="background: rgba(255, 255, 255, 0.92); backdrop-filter: blur(15px); padding: 18px 28px; border-radius: 18px; display: flex; align-items: center; justify-content: space-between; box-shadow: 0 8px 28px rgba(0,0,0,0.2);">
                    ...
                    <div style="background: ${gradient}; color: white; padding: 8px 20px; border-radius: 14px; font-size: 30px; font-weight: 900; box-shadow: 0 4px 16px rgba(0,0,0,0.2); min-width: 60px; text-align: center; display: flex; align-items: center; justify-content: center; line-height: 1;">
