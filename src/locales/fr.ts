export const fr = {
  ...
  travelPlanner: {
    ...
    selectDayDescription: 'Choisissez un jour pour voir les offres disponibles',
    ...
    useItinerary: 'Utiliser cet itinéraire',
    whyPassBali: 'Pourquoi PassBali?',
    benefit1: '200+ offres exclusives à travers Bali',
    benefit2: 'Économisez jusqu\'à 50% sur vos activités',
    benefit3: 'Planifiez votre voyage avec notre outil interactif',
    benefit4: 'Pass unique valable 1 an à partir de l\'activation',
    discoverPassBali: 'Découvrir PassBali',
    itineraryOverview: 'Aperçu de l\'itinéraire',
    readyForAdventure: 'Prêt à vivre cette aventure ?',
    ...
    shareInstagramStory: 'Partager en story Instagram',
    shareOn: 'Partager sur',
    shareError: 'Erreur lors du partage',
    imageDownloaded: 'Image téléchargée ! Vous pouvez maintenant la publier sur Instagram.',
