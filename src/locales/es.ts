export const es = {
  ...
  travelPlanner: {
    ...
    selectDayDescription: 'Elija un día para ver las ofertas disponibles',
    ...
    useItinerary: 'Usar este itinerario',
    whyPassBali: '¿Por qué PassBali?',
    benefit1: '200+ ofertas exclusivas en todo Bali',
    benefit2: 'Ahorra hasta un 50% en tus actividades',
    benefit3: 'Planifica tu viaje con nuestra herramienta interactiva',
    benefit4: 'Pase único válido durante 1 año desde la activación',
    discoverPassBali: 'Descubrir PassBali',
    itineraryOverview: 'Resumen del itinerario',
    readyForAdventure: '¿Listo para vivir esta aventura?',
    duplicateItinerary: 'Duplica este itinerario y personalízalo a tu gusto con PassBali',
    cities: 'ciudades',
    noOffersPlanned: 'No hay ofertas planificadas',
    dailyPlan: 'Plan diario',
    generateLink: 'Generar enlace',
    generating: 'Generando...',
    duplicating: 'Duplicando...',
    signInToDuplicate: 'Iniciar sesión para duplicar',
    loading: 'Cargando...',
