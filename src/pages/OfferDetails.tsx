...
import { ArrowLeft, MapPin, Star, Heart, Clock, Share2, Percent, Euro, Navigation, Phone, Globe, Instagram, Calendar, CheckCircle, Sparkles, Gift, ChevronLeft, ChevronRight, ExternalLink } from "lucide-react";
        ...
        <div className="relative h-80 overflow-hidden">
          ...
          {offer.value_text && (
            <div className="absolute top-4 left-4 animate-fade-in">
              <div className="px-3 py-1.5 rounded-xl text-white text-sm font-medium backdrop-blur-lg bg-primary/70 border border-white/10 shadow-lg">
                <span>{offer.value_text}</span>
              </div>
            </div>
          )}
